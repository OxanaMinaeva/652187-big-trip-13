...
export const createTripEventTemplate = (event) => {
  ...
  return `<ul class="trip-events__list">
            <li class="trip-events__item">
              <div class="event">
                <time class="event__date" datetime="${dayjs(date).toISOString()}">${date.format(`MMM DD`)}</time>
                ...
                <div class="event__schedule">
                  <p class="event__time">
                    <time class="event__start-time" datetime="">${startTime.format(`HH:mm`)}</time>
                    &mdash;
                    <time class="event__end-time" datetime="">${endTime.format(`HH:mm`)}</time>
                  </p>
